...
public interface DailyEffortRepository extends JpaRepository<DailyEffortEntry, Integer> {
    ...
    @Query("SELECT d FROM DailyEffortEntry d " +
           ...
           "LEFT JOIN FETCH r.developerName dev " +
           "LEFT JOIN FETCH d.module m " +
           "WHERE w.weekId = :weekId AND d.project.projectId = :projectId")
    List<DailyEffortEntry> findByWeekIdAndProjectIdWithDetails(@Param("weekId") Integer weekId, @Param("projectId") Integer projectId);
    ...
    @Query("SELECT d FROM DailyEffortEntry d " +
           ...
           "LEFT JOIN FETCH d.activity act " +
           "LEFT JOIN FETCH d.status stat " +
           "WHERE r.resourceId = :resourceId AND d.project.projectId = :projectId")
    List<DailyEffortEntry> findByResourceIdAndProjectIdWithDetails(@Param("resourceId") Integer resourceId, @Param("projectId") Integer projectId);
    ...
    @Query("SELECT d FROM DailyEffortEntry d " +
           ...
           "ORDER BY d.workDate DESC")
    List<DailyEffortEntry> findByWeekIdAndUserIdAndProjectIdForLogs(@Param("weekId") Integer weekId, @Param("userId") String userId, @Param("projectId") Integer projectId);
}
